        ...
        <div class="block o-mt">
            <el-form class="o-pt" ref="form" :rules="Rules" :model="Params" label-width="100px">
                ...
                <el-form-item label="名称" prop="organName" style="width:100%; max-width:460px;">
                    <el-input v-model="Params.organName" placeholder="请输入机构名称" clearable></el-input>
                </el-form-item>
                <el-form-item label="简述" prop="intro" style="width:100%; max-width:460px;">
                    <el-input v-model="Params.intro" placeholder="请输入简述" clearable></el-input>
                </el-form-item>
                <el-form-item label="经度" prop="longitude" style="width:100%; max-width:460px;">
                    <el-input v-model="Params.longitude" placeholder="请输入经度" clearable></el-input>
                </el-form-item>
                <el-form-item label="纬度" prop="latitude" style="width:100%; max-width:460px;">
                    <el-input v-model="Params.latitude" placeholder="请输入纬度" clearable></el-input>
                </el-form-item>
                <el-form-item label="地址" prop="altitudeName" style="width:100%; max-width:460px;">
                    <el-input v-model="Params.altitudeName" placeholder="请输入地址" clearable></el-input>
                </el-form-item>                
                ...
                <el-form-item label="类目" prop="categoryId" style="width:100%; max-width:460px;">
                    <el-select v-model="Params.categoryId" placeholder="请选择类目">
                ...
                <el-form-item label="服务内容"  prop="serveIdsList">
                    ...
                    <el-checkbox-group v-model="serveIdsList">
                        <div class="o-pl">
                            <el-checkbox @change="serviceContentC"  v-for="(item,unit) in serviceContentList" :label="item.id" :key="item.id">{{item.content}}</el-checkbox>
                        </div>
                    </el-checkbox-group>
                ...
                <el-form-item label="机构账号" prop="organAccount" style="width:100%; max-width:460px;" >
                    <el-input v-model="Params.organAccount" placeholder="请输入机构账号" ></el-input>
                </el-form-item>
                ...
                <el-form-item  prop="status" label="状态"  style="width:100%; max-width:460px;">
                    <el-radio  v-model="Params.status" label="n">启用</el-radio>
                    <el-radio   v-model="Params.status" label="y">停用</el-radio>
                </el-form-item>
                <el-form-item>
                    <Button @click="FormSubmitCheck()" long>提交</Button>
    ...
    data() {
        return {
            ...
            Rules: {
                ...
                altitudeName: [ { required: true, message: '请输入地址', trigger: 'blur' } ],
               ...
               // debugger
                if(res.code == 200){
                    ...
                    if(this.Params.serveIds){
                        ...
                        this.$set(this.Params,'serveIdsList',this.serveIdsList)
